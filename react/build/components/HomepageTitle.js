...
var HomepageTitle = function (_React$Component) {
    _inherits(HomepageTitle, _React$Component);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'button', onClick: this.props.onLoginButtonClick },
                        'Log In'
                    ),
                    _react2.default.createElement(
                        'button',
                        { className: 'button', onClick: this.props.onSignupButtonClick },
                        'Sign Up'
                    )
                )
            );
