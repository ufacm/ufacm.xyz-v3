    ...
    render() {
        return <div className="homepage-title">
          <div className="title-container">
            ...
            <button className="clickable button" onClick={this.props.onLoginButtonClick}>Log In</button>
            <button className="clickable button" onClick={this.props.onSignupButtonClick}>Sign Up</button>
          </div>
          <ParticlesCanvas />
        </div>;
    }
